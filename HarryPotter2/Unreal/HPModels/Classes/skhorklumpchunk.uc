...
class skhorklumpchunk extends HPMesh abstract;
#exec MESH  MODELIMPORT MESH=skhorklumpchunkMesh MODELFILE=models\skhorklumpchunk.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=skhorklumpchunkMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=skhorklumpchunkAnims ANIMFILE=models\skhorklumpchunk.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=skhorklumpchunkTex0  FILE=TEXTURES\HP2horklump_SKIN00.bmp  GROUP=Skins
