...
class skhorklumpsHead extends HPMesh abstract;
#exec MESH  MODELIMPORT MESH=skhorklumpsHeadMesh MODELFILE=models\skhorklumpsHead.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=skhorklumpsHeadMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=skhorklumpsHeadAnims ANIMFILE=models\skhorklumpsHead.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=skhorklumpsHeadTex0  FILE=TEXTURES\HP2horklump_SKIN00.bmp  GROUP=Skins
