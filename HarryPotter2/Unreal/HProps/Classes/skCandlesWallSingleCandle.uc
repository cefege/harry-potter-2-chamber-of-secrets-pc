...
#exec MESH  MODELIMPORT MESH=skCandlesWallSingleCandleMesh MODELFILE=models\skCandlesWallSingleCandle.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=skCandlesWallSingleCandleMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=skCandlesWallSingleCandleAnims ANIMFILE=models\skCandlesWallSingleCandle.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=skCandlesWallSingleCandleTex0  FILE=TEXTURES\wallcndl_128.bmp  GROUP=Skins
