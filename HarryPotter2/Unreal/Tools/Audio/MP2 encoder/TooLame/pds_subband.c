...
void
read_ana_window (double FAR ana_win[HAN_SIZE]);
...
#ifdef COMBWS
void
window_subband (short **buffer, double s[SBLIMIT], int k, int sblimit)
{
