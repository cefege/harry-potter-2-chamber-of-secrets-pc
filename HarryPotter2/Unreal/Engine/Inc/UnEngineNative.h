...
ENGINE_API void RegisterCheckSumCommandletClass();
ENGINE_API void RegisterParticleListPrivateClass();
...
/*	UMusic::StaticClass();*/\
	...
	AInterpolationManager::StaticClass(); \
	UParticleList::StaticClass();	\
	AParticleFX::StaticClass();	\
	USkeletalMesh::StaticClass();	\
	AAnimChannel::StaticClass();	\
	AClipMarker::StaticClass();	\
	AWind::StaticClass();	\
	UAlignedOvalCylinder::StaticClass();	\
	UBox::StaticClass();	\
	UBoxPrim::StaticClass();	\
	UChannelDownload::StaticClass();	\
	RegisterCheckSumCommandletClass();	\
	UDownload::StaticClass();	\
	UEngineTextureFactory::StaticClass();	\
	UGameSaveInfo::StaticClass();	\
	UGesture::StaticClass();	\
	UI3DL2Listener::StaticClass();	\
	UImpactSoundSet::StaticClass();	\
	UOrientedCylinder::StaticClass();	\
	UOrientedOvalCylinder::StaticClass();	\
	RegisterParticleListPrivateClass();	\
	USoundContainer::StaticClass();	\
