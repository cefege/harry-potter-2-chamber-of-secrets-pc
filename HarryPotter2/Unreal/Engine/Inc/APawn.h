...
//	virtual UBOOL Tick( FLOAT DeltaTime, enum ELevelTick TickType );
	...
	// Path finding
	bool findPath(ANavigationPoint *&next, AActor* startPoint, FName DestName);

	void givePathEnds(int whichRS, AActor * endA, AActor * endB);
	...
	bool Mount(const FVector& MountDelta, FCheckResult &Hit);
