...
enum ESpellType
{
    ...
    SPELL_Skurge            =20,
    SPELL_Spongify          =21,
    SPELL_Rictusempra       =22,
    SPELL_Ecto              =23,
    SPELL_Fire              =24,
    SPELL_DuelRictusempra   =25,
    SPELL_DuelMimblewimble  =26,
    SPELL_DuelExpelliarmus  =27,
    SPELL_MAX               =28,
};
enum ENetRole
{
...
public:
    ...
    void eventDemoPlaySound(class USound* Sound, BYTE Slot, FLOAT Volume, BITFIELD bNoOverride, FLOAT Radius, FLOAT Pitch, BITFIELD Disable3D, BITFIELD Loop)
    {
...
public:
    ...
    void eventClientHearSound(class AActor* Actor, INT Id, class USound* S, FVector SoundLocation, FVector Parameters, BITFIELD Disable3D, BITFIELD Loop)
    {
...
enum EMoverEncroachType
{
    ...
    ME_ReallyStopWhenEncroach=4,
    ME_ReallyReturnWhenEncroach=5,
    ME_ReallyCrushWhenEncroach=6,
    ME_ReallyIgnoreWhenEncroach=7,
    ME_MAX                  =8,
};
...
public:
    ...
    #include "AInterpolationManager.h"
};
