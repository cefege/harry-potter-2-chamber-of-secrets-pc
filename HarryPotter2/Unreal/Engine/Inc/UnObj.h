...
enum EPolyFlags
{
	...
	//HP2 Specific
	PF_LumosAffected	= PF_HighShadowDetail | PF_Modulated,	// A lumosAffected surface will disappear by default
	PF_LumosDisappear	= PF_LumosAffected,						// Same as being affected
	PF_LumosAppear		= PF_Gouraud,							// The flag that marks appearing rather than disappearing
	PF_LumosAlwaysOn	= PF_DirtyShadows,						// This flag will make the lumos surface always on
};
