...
struct ENGINE_API FSceneNode
{
	...
	FLOAT			EffectiveFovAngle; // Horizontal FOV used by this frame's perspective projection.
...
#if ASM && defined(_MSC_VER) && defined(_M_IX86)
		__asm
		{
...
#elif ASMLINUX && defined(__i386__)
...
class ENGINE_API URenderBase : public USubsystem
{
	...
	virtual UBOOL BoundVisible( FSceneNode* Frame, const FCoords& BoxCoords, FSpanBuffer* SpanBuffer, FScreenBounds& Results )=0;
	...
	virtual void DrawCylinder( FSceneNode* Frame, FPlane Color, DWORD LineFlags, const FCoords& Place, FLOAT Radius, FLOAT Height, FLOAT Width = -1 )=0;
};
