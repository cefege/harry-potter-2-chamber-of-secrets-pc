...
// TG ALPHA #exec OBJ LOAD FILE=..\music\JS_StoryBook_v2_mx.umx PACKAGE=Engine
// TG ALPHA #exec OBJ LOAD FILE=..\music\JS_HP_Title_Screen_v2 PACKAGE=Engine
...
var(Audio) const string Song;          // Default song for level.
...
//****************************************************************
var PlayerPawn PlayerHarryActor;
//****************************************************************
...
event PreBeginPlay()
{
	foreach AllActors( class'PlayerPawn', PlayerHarryActor)
		break;
...
//     Song=Music'Engine.Arg_Crabbe_Goyle1_loop'
     CdTrack=255
     Brightness=1.000000
