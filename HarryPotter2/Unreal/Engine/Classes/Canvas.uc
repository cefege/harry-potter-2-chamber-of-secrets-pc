...
const HUD_BASE_RESOLUTION_X  = 800.0;   // Hud icons are made to look good in
...
native(465) final function DrawText( coerce string Text, optional bool CR, optional int numChars, optional bool bCursor );
...
function float GetHudScaleFactor()
{
	return (SizeX / HUD_BASE_RESOLUTION_X);
}

function float GetBaseResolutionX()
{
	return (HUD_BASE_RESOLUTION_X);
}
