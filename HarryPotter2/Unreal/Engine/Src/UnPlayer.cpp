...
void UPlayer::StaticConstructor()
{
	guard(UPlayer::StaticConstructor);
	new(GetClass(),TEXT("Actor"),RF_Public)UObjectProperty(CPP_PROPERTY(Actor),TEXT("Player"),CPF_Transient,APlayerPawn::StaticClass());
	unguard;
}
