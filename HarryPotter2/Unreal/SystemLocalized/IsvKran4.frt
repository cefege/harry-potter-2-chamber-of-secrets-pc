...
[TranslatorEvent13]
Message=Panneau de contrôle des barres de sécurité entrepôt : PANNEAU HORS LIGNE - RÉROUTER L'ALIMENTATION DEPUIS LA CONSOLE ORDINATEUR.
AltMessage=Barres de sécurité entrepôt désactivées : Accès au hangar autorisé.
...
[TranslatorEvent12]
Message=ALIMENTATION DÉROUTÉE VERS PANNEAU DE CONTRÔLE DES BARRES DE SÉCURITÉ ENTREPÔT.
...
[TranslatorEvent36]
Message=Quartier-maître : Youri Andromov : La troupe d'aliens a ouvert une brèche dans la coque et pénètrent dans le vaisseau par les conduits de ventilation - Kerig, Onsov et moi allons prendre position avec des stingers sur l'aire de chargement, ici.
