...
[TranslatorEvent0]
message=Navigateur : Vortex Rikers. Nous nous dirigeons vers le pénitentier. Des masses magnétiques inconnues ont été détectées dans le Secteur Gamma 83H. Le capitaine a ordonné un changement de cap.
Hint=Donnez un coup de tête sur le bouton de l'Arsenal pour désactiver le champ de force.
...
[TranslatorEvent8]
message=Journal de Boris Clague, 3e jour : Je suis là depuis trois jours et j'ai déjà deux côtes brisées, un fracture du fémur et quatorze points de suture. Je ne sais pas si je vais finir la semaine et débarquer sur la lune pénitentiaire.
