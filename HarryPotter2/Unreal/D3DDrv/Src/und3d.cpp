...
//			{
				for( INT i=0; i<NumPts; i++ )
					Verts[i].dcColor = RGBA_MAKE( appRound(255.f*Stages[0].MaxColor.X), appRound(255.f*Stages[0].MaxColor.Y), appRound(255.f*Stages[0].MaxColor.Z), appRound(255.f*Stages[0].MaxColor.Z) );				
//			}
//			else
//			{
//				for( INT i=0; i<NumPts; i++ )
