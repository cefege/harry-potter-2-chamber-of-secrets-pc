...
# PROP Scc_ProjName ""$/unreal/WinDrv", GVMAAAAA"
# PROP Scc_LocalPath ".."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD CPP /nologo /Zp4 /MD /W4 /WX /vd0 /GX /O2 /Ob2 /I "." /I "..\Inc" /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /I "..\..\Window\Inc" /D WINDRV_API=__declspec(dllexport) /D "_WINDOWS" /D "NDEBUG" /D "UNICODE" /D "_UNICODE" /D "WIN32" /Yu"WinDrv.h" /FD /Zm256 /c
...
# ADD LINK32 ..\..\Window\Lib\Window.lib ..\..\Core\Lib\Core.lib ..\..\Engine\Lib\Engine.lib ..\Lib\ddraw.lib ..\Lib\dxguid.lib gdi32.lib kernel32.lib user32.lib winmm.lib imm32.lib /nologo /base:"0x11100000" /subsystem:windows /dll /incremental:yes /machine:I386 /out:"..\..\System\WinDrv.dll"
...
# ADD CPP /nologo /Zp4 /MDd /W4 /WX /Gm /vd0 /GX /ZI /Od /I "." /I "..\Inc" /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /I "..\..\Window\Inc" /D "_WINDOWS" /D WINDRV_API=__declspec(dllexport) /D "UNICODE" /D "_UNICODE" /D "_DEBUG" /D "WIN32" /FD /Zm256 /c
...
# ADD LINK32 ..\..\Window\Lib\Window.lib ..\..\Core\Lib\Core.lib ..\..\Engine\Lib\Engine.lib ..\Lib\ddraw.lib ..\Lib\dxguid.lib gdi32.lib kernel32.lib user32.lib winmm.lib imm32.lib /nologo /base:"0x11100000" /subsystem:windows /dll /debug /machine:I386 /out:"..\..\System\WinDrv.dll" /pdbtype:sept
...
# PROP Default_Filter "*.rc;*.res;*.ico;*.cur;*.bmp"
# Begin Source File
