//=============================================================================
// ShortCutListSounds - list of bookmarks
//=============================================================================
...
{
	//baseHarry(root.console.viewport.Actor).theNarrator.DeliverDialog(MasterList[row]);
}
...
function PaintColumn(Canvas C, UWindowGridColumn Column, float MouseX, float MouseY) 
{
	...
	while( CurRow < LastRow )
	{
		...
		switch( Column.ColumnNum )
		{
			...
			case 1:	Column.ClipText( C, 2, TopMargin + CurOffset, status[CurRow] );				break;
			case 2:	Column.ClipText( C, 2, TopMargin + CurOffset, MasterList[CurRow] );				break;
			case 3:	Column.ClipText( C, 2, TopMargin + CurOffset, MasterText[CurRow] );	break;
		}
