			...
			case IDMN_MB_IMPORT:
				{
					...
					ofn.lpstrFilter = "Music Files (*.mod, *.s3m, *.stm, *.it, *.xm, *.far, *.669, *.mp2)\0*.mod;*.s3m;*.stm;*.it;*.xm;*.far;*.669;*.mp2\0Amiga Modules (*,mod)\0*.mod\0Scream Tracker 3 (*.s3m)\0*.s3m\0Scream Tracker 2 (*.stm)\0*.stm\0Impulse Tracker (*.it)\0*.it\0Fasttracker 2\0*,xm\0Farandole (*.far)\0*.far\0ComposD (*.669)\0*.669\0Mpeg 2 Stream (*.mp2)\0*.mp2\0All Files\0*.*\0\0";
					ofn.lpstrDefExt = "*.mod;*.s3m;*.stm;*.it;*.xm;*.far;*.669;*.mp2";
