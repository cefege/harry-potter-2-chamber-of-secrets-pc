...
public:
	...
	{
		Ar.ByteOrderSerialize( &W, appCheckedIntSize(sizeof(W)) );
		return Ar;
	}
	...
	{
		Ar.ByteOrderSerialize( &D, appCheckedIntSize(sizeof(D)) );
		return Ar;
	}
	friend FArchive& operator<<( FArchive& Ar, INT& I )
	{
		Ar.ByteOrderSerialize( &I, appCheckedIntSize(sizeof(I)) );
		return Ar;
	}
	friend FArchive& operator<<( FArchive& Ar, FLOAT& F )
	{
		Ar.ByteOrderSerialize( &F, appCheckedIntSize(sizeof(F)) );
		return Ar;
	}
	friend FArchive& operator<<( FArchive &Ar, QWORD& Q )
	{
		Ar.ByteOrderSerialize( &Q, appCheckedIntSize(sizeof(Q)) );
		return Ar;
	}
