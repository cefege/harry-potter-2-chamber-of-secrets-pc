...
enum EExprToken
{
	...
	EX_DynArrayCount		= 0x37,	// Return size of dynamic array.
	EX_DebugInfo			= 0x38,	//DEBUGGER Debug information

	EX_GlobalFunction		= 0x39, // Call non-state version of a function.



	// Native conversions.
	EX_MinConversion		= 0x3a,	// Minimum conversion token.
	EX_RotatorToVector		= 0x3a,
	EX_ByteToInt			= 0x3b,
	EX_ByteToBool			= 0x3c,
	EX_ByteToFloat			= 0x3d,
	EX_IntToByte			= 0x3e,
...
{	
	...
	FFrame( UObject* InObject, UStruct* InNode, INT CodeOffset, void* InLocals, FFrame* InParent = NULL );
