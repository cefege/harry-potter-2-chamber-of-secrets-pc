...
# PROP Scc_ProjName ""$/Demo/unreal/Core", "
# PROP Scc_LocalPath ".."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD CPP /nologo /Zp4 /MD /W4 /WX /vd0 /GX /Ox /Ot /Oa /Og /Oi /Ob2 /I "..\Inc" /I "..\..\Vorbis\Inc" /I "..\..\EAAudioCodec\Include" /D CORE_API=__declspec(dllexport) /D "_WINDOWS" /D "NDEBUG" /D "UNICODE" /D "_UNICODE" /D "WIN32" /FR /YX"CorePrivate.h" /FD /Zm256 /c
...
# ADD LINK32 gdi32.lib user32.lib kernel32.lib winmm.lib shell32.lib ole32.lib advapi32.lib vorbisfile.lib codapcz.lib /nologo /base:"0x10100000" /subsystem:windows /dll /incremental:yes /machine:I386 /out:"..\..\System\Core.dll" /libpath:"..\..\Vorbis\Lib\release" /libpath:"..\..\EAAudioCodec\lib"
...
# ADD CPP /nologo /Zp4 /MDd /W4 /WX /vd0 /GX /ZI /Od /I "..\Inc" /I "..\..\Vorbis\Inc" /I "..\..\EAAudioCodec\Include" /D "_WINDOWS" /D CORE_API=__declspec(dllexport) /D "UNICODE" /D "_UNICODE" /D "_DEBUG" /D "WIN32" /D "DEBUG" /FR /FD /Zm256 /c
...
# ADD LINK32 gdi32.lib user32.lib kernel32.lib winmm.lib shell32.lib ole32.lib advapi32.lib vorbisfile.lib codapcd.lib /nologo /base:"0x10100000" /subsystem:windows /dll /debug /debugtype:both /machine:I386 /nodefaultlib:"LIBCMT" /out:"..\..\System\Core.dll" /pdbtype:sept /libpath:"..\..\Vorbis\Lib\debug" /libpath:"..\..\EAAudioCodec\lib"
...
SOURCE=..\Inc\FFileManagerUnix.h
# End Source File
# Begin Source File

SOURCE=..\Inc\FFileManagerPSX2.h
# End Source File
# Begin Source File
...
SOURCE=..\Classes\SimpleCommandlet.uc
# End Source File
# Begin Source File
