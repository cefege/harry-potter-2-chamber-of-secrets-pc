...
CORE_API INT PACKAGE_FILE_VERSION = 79;
CORE_API INT PACKAGE_MIN_VERSION = 60;
...
CORE_API UBOOL					GEncryptLoad=0;					/* added by gk knowwonder enable encrypted load  */
CORE_API UBOOL					GCurrentEncrypt=0;				/* added by gk knowwonder set if current file encrypted */
CORE_API UDebugger*				GDebugger=NULL;					//DEBUGGER /* Unrealscript Debugger */
CORE_API FFileStream*			GFileStream;																				// TG ALPHA
CORE_API FLOAT					GAudioMaxRadiusMultiplier=100.f;/* Max distance = Radius * GAudioMaxRadiusMultiplier */		// TG ALPHA
CORE_API FLOAT					GAudioDefaultRadius=450.f;		/* Default radius for PlayOwnedSound */						// TG ALPHA

#if STATS
CORE_API FStats					GStat;
#endif
...
// System identification. Apple arm64 always selects scalar code paths.
